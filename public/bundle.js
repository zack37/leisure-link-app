...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcInfrastructureRoutes = __webpack_require__(196);

	var _srcInfrastructureRoutes2 = _interopRequireDefault(_srcInfrastructureRoutes);

	_reactRouter2['default'].run(_srcInfrastructureRoutes2['default'], _reactRouter2['default'].HistoryLocation, function (Handler) {
	  _react2['default'].render(_react2['default'].createElement(Handler, null), document.getElementById('main-content'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsNavbar = __webpack_require__(201);

	var _viewsNavbar2 = _interopRequireDefault(_viewsNavbar);

	var _viewsMoviesMoviesBox = __webpack_require__(202);

	var _viewsMoviesMoviesBox2 = _interopRequireDefault(_viewsMoviesMoviesBox);

	var _viewsActorsActorsBox = __webpack_require__(197);

	var _viewsActorsActorsBox2 = _interopRequireDefault(_viewsActorsActorsBox);

	var _viewsDirectorsDirectorsBox = __webpack_require__(206);

	var _viewsDirectorsDirectorsBox2 = _interopRequireDefault(_viewsDirectorsDirectorsBox);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        null,
	        _react2['default'].createElement(_viewsNavbar2['default'], null),
	...
	var routes = _react2['default'].createElement(
	  ...
	  _react2['default'].createElement(Route, { name: 'movies', handler: _viewsMoviesMoviesBox2['default'], path: '/movies' }),
	  _react2['default'].createElement(Route, { name: 'actors', handler: _viewsActorsActorsBox2['default'], path: '/actors' }),
	  _react2['default'].createElement(Route, { name: 'directors', handler: _viewsDirectorsDirectorsBox2['default'], path: '/directors' }),
	  _react2['default'].createElement(DefaultRoute, { handler: App })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ActorsList = __webpack_require__(198);

	var _ActorsList2 = _interopRequireDefault(_ActorsList);

	var _ActorForm = __webpack_require__(208);

	var _ActorForm2 = _interopRequireDefault(_ActorForm);

	var ActorsBox = (function (_React$Component) {
	  function ActorsBox(props) {
	    _classCallCheck(this, ActorsBox);

	    _get(Object.getPrototypeOf(ActorsBox.prototype), 'constructor', this).call(this, props);
	  ...
	  _inherits(ActorsBox, _React$Component);

	  _createClass(ActorsBox, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      $.ajax({
	        ...
	        success: (function (data) {
	          _this.setState({ actors: data });
	        }).bind(this)
	      });
	    }
	  }, {
	    key: 'actorSelected',
	    value: function actorSelected(selectedActor) {
	      this.setState({ actors: this.state.actors, selectedActor: selectedActor, actorSelected: true });
	    }
	  }, {
	    key: 'createActor',
	    value: function createActor(newActor) {
	      var _this2 = this;
	      ...
	      $.ajax({
	        ...
	        data: newActor,
	        success: (function (data) {
	          var actors = _this2.state.actors;
	    ...
	    key: 'editActor',
	    value: function editActor(newActor) {
	      this.setState({ actors: this.state.actors, selectedActor: {}, actorSelected: false });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var detail = this.state.actorSelected ? _react2['default'].createElement(_ActorForm2['default'], { actor: this.state.selectedActor }) : {};
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'row' },
	          _react2['default'].createElement(_ActorForm2['default'], { createActor: this.createActor }),
	          detail
	        ),
	        _react2['default'].createElement(_ActorsList2['default'], { actors: this.state.actors, onActorSelect: this.actorSelected })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ActorNode = __webpack_require__(199);

	var _ActorNode2 = _interopRequireDefault(_ActorNode);

	var ActorsList = (function (_React$Component) {
	  function ActorsList() {
	    _classCallCheck(this, ActorsList);

	    _get(Object.getPrototypeOf(ActorsList.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _inherits(ActorsList, _React$Component);

	  _createClass(ActorsList, [{
	    key: 'render',
	    value: function render() {
	      var actorRows = [];
	      ...
	      if (this.props.actors) {
	        ...
	        actorRows = this.props.actors.map(function (actor) {
	          return _react2['default'].createElement(_ActorNode2['default'], { actor: actor, onSelect: self.props.onActorSelect });
	        });
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActorNode = (function (_React$Component) {
	  function ActorNode(props) {
	    _classCallCheck(this, ActorNode);

	    _get(Object.getPrototypeOf(ActorNode.prototype), "constructor", this).call(this, props);
	    this.rowClicked = this.rowClicked.bind(this);
	  }

	  _inherits(ActorNode, _React$Component);
	  ...
	  _createClass(ActorNode, [{
	    ...
	    value: function render() {
	      ...
	      if (this.props.actor.moviesActedIn) {
	        moviesList = this.props.actor.moviesActedIn.map(function (movie) {
	          return _react2["default"].createElement(
	            "li",
	            null,
	            movie
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MoviesList = __webpack_require__(203);

	var _MoviesList2 = _interopRequireDefault(_MoviesList);

	var _MovieCreateForm = __webpack_require__(205);

	var _MovieCreateForm2 = _interopRequireDefault(_MovieCreateForm);

	var MoviesBox = (function (_React$Component) {
	  function MoviesBox(props) {
	    _classCallCheck(this, MoviesBox);

	    _get(Object.getPrototypeOf(MoviesBox.prototype), 'constructor', this).call(this, props);
	    this.state = { movies: [] };
	  ...
	  _createClass(MoviesBox, [{
	    ...
	    key: 'createMovie',
	    value: function createMovie(newMovie) {
	      var _this = this;
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        null,
	        _react2['default'].createElement(_MovieCreateForm2['default'], { createMovie: this.createMovie }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MovieNode = __webpack_require__(204);

	var _MovieNode2 = _interopRequireDefault(_MovieNode);

	var MoviesList = (function (_React$Component) {
	  function MoviesList(props) {
	    _classCallCheck(this, MoviesList);

	    _get(Object.getPrototypeOf(MoviesList.prototype), 'constructor', this).call(this, props);
	  }
	    ...
	    value: function render() {
	      ...
	      if (this.props.movies) {
	        var movieRows = this.props.movies.map(function (movie) {
	          return _react2['default'].createElement(_MovieNode2['default'], { movie: movie });
	        });
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MovieNode = (function (_React$Component) {
	  function MovieNode(props) {
	    _classCallCheck(this, MovieNode);

	    _get(Object.getPrototypeOf(MovieNode.prototype), 'constructor', this).call(this, props);
	  }

	  _inherits(MovieNode, _React$Component);

	  _createClass(MovieNode, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'tr',
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'ul',
	            null,
	            this.props.movie.actors.map(function (actor) {
	              return _react2['default'].createElement(
	                'li',
	                null,
	                actor
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'ul',
	            null,
	            this.props.movie.directors.map(function (director) {
	              return _react2['default'].createElement(
	                'li',
	                null,
	                director
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MovieCreateForm = (function (_React$Component) {
	  function MovieCreateForm(props) {
	    _classCallCheck(this, MovieCreateForm);

	    _get(Object.getPrototypeOf(MovieCreateForm.prototype), 'constructor', this).call(this, props);
	    this.handleSubmit = this.handleSubmit.bind(this);
	  }

	  _inherits(MovieCreateForm, _React$Component);

	  _createClass(MovieCreateForm, [{
	    key: 'handleSubmit',
	    value: function handleSubmit(e) {
	      e.preventDefault();
	      var newMovie = {
	        name: _react2['default'].findDOMNode(this.refs.name).value,
	        description: _react2['default'].findDOMNode(this.refs.description).value,
	        yearReleased: _react2['default'].findDOMNode(this.refs.yearReleased).value,
	        rating: _react2['default'].findDOMNode(this.refs.rating).value
	      };
	      this.props.createMovie(newMovie);
	      _react2['default'].findDOMNode(this.refs.name).value = '';
	      _react2['default'].findDOMNode(this.refs.description).value = '';
	      _react2['default'].findDOMNode(this.refs.yearReleased).value = '';
	      _react2['default'].findDOMNode(this.refs.rating).value = '';
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var year = new Date().getFullYear();
	      var yearReleasedPlaceholder = 'Year Released (1800 - ' + year + ')';

	      return _react2['default'].createElement(
	        'form',
	        { className: 'form-horizontal col-md-6', onSubmit: this.handleSubmit },
	        _react2['default'].createElement(
	          'fieldset',
	          null,
	          _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement('input', { type: 'text', className: 'form-control', placeholder: 'Movie Title', required: 'required', ref: 'name' })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'form-group col-md-12' },
	            _react2['default'].createElement('textarea', { className: 'form-control', placeholder: 'Description', ref: 'description' })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'form-group col-md-12' },
	            _react2['default'].createElement('input', { type: 'number', className: 'form-control', min: '1800', max: year, required: 'required', placeholder: yearReleasedPlaceholder, ref: 'yearReleased' })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'form-group col-md-12' },
	            _react2['default'].createElement('input', { type: 'number', className: 'form-control', min: '1', max: '10', step: '.1', required: 'required', placeholder: 'Rating (1-10)', ref: 'rating' })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'form-group' },
	            _react2['default'].createElement('input', { type: 'submit', value: 'Add', className: 'btn btn-success col-md-2 col-md-offset-9' })
	          )
	        )
	      );
	    }
	  ...
	  return MovieCreateForm;
	})(_react2['default'].Component);

	exports['default'] = MovieCreateForm;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DirectorsBox = (function (_React$Component) {
	  function DirectorsBox() {
	    _classCallCheck(this, DirectorsBox);

	    _get(Object.getPrototypeOf(DirectorsBox.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _inherits(DirectorsBox, _React$Component);

	  _createClass(DirectorsBox, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'h1',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActorForm = (function (_React$Component) {
	  function ActorForm(props) {
	    _classCallCheck(this, ActorForm);

	    _get(Object.getPrototypeOf(ActorForm.prototype), 'constructor', this).call(this, props);
	    this.handleCreate = this.handleCreate.bind(this);
	    this.state = { actor: this.props.actor || {} };
	  }

	  _inherits(ActorForm, _React$Component);

	  _createClass(ActorForm, [{
	    key: 'handleCreate',
	    value: function handleCreate(e) {
	      ...
	      var newActor = {
	        ...
	        name: _react2['default'].getDOMNode(this.refs.name).value,
	        age: _react2['default'].getDOMNode(this.refs.age).value,
	        gender: _react2['default'].getDOMNode(this.refs.gender).value,
	        agent: _react2['default'].getDOMNode(this.refs.agent).value
	      };
	      this.props.createActor(newActor);
	      _react2['default'].getDOMNode(this.refs.name).value = '';
	      _react2['default'].getDOMNode(this.refs.age).value = '';
	      _react2['default'].getDOMNode(this.refs.gender).value = '';
	      _react2['default'].getDOMNode(this.refs.agent).value = '';
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'form',
	        { className: 'form-horizontal col-md-6', onSubmit: submitFunc },
	        _react2['default'].createElement(
	          'fieldset',
	          null,
	          _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'div',
	            { className: 'form-group col-md-12' },
	            _react2['default'].createElement('input', { type: 'text', className: 'form-control', defaultValue: this.state.actor.name, required: 'required', ref: 'name', placeholder: 'Name' })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'form-group col-md-12' },
	            _react2['default'].createElement('input', { type: 'number', className: 'form-control', defaultValue: this.state.actor.age, min: '1', max: '125', required: 'required', ref: 'age', placeholder: 'Age' })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'form-group col-md-12' },
	            _react2['default'].createElement(
	              'select',
	              { className: 'form-control', defaultValue: this.state.actor.gender, required: 'required', ref: 'gender' },
	              _react2['default'].createElement(
	                'option',
	          ...
	          _react2['default'].createElement(
	            'div',
	            { className: 'form-group col-md-12' },
	            _react2['default'].createElement('input', { type: 'text', className: 'form-control', defaultValue: this.state.actor.agent, ref: 'agent', placeholder: 'Name of Agent' })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'form-group' },
	            _react2['default'].createElement('input', { type: 'submit', value: submitButtonText, className: 'btn btn-success col-md-2 col-md-offset-9' })
	          )
	        )
	      );
	    }
